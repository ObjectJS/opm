...
XMLConfigLoader.prototype.fill = function(package) {
	package.id = this.attr('/package/@id') || this.attr('/package/@url');
	package.version = this.attr('/package/@version');
	package.sourceDir = this.attr('//source/@dir') || package.sourceDir;
	package.resourceDir = this.attr('//resource/@dir') || package.resourceDir;
	package.libraryDir = this.attr('//library/@dir') || package.libraryDir;
