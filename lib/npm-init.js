...
var parentRoot = path.join(dirname, '../..');
if (fs.existsSync(path.join(parentRoot, 'components'))) {
  var parentName = require(path.join(parentRoot, 'package.json')).name;
  exports.name = prompt('name', package.name || parentName + '_' + basename);
} else {
